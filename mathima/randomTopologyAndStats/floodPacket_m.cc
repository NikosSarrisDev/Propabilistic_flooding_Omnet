...
FloodPacket::FloodPacket(const char *name, short kind) : ::omnetpp::cPacket(name, kind)
{
}

FloodPacket::FloodPacket(const FloodPacket& other) : ::omnetpp::cPacket(other)
{
    copy(other);
}
...
void FloodPacket::copy(const FloodPacket& other)
{
    ...
    this->sendingTimeInstace = other.sendingTimeInstace;
}
...
void FloodPacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->sendingTimeInstace);
}
...
void FloodPacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->sendingTimeInstace);
}

int FloodPacket::getSender() const
{
    return this->sender;
}

void FloodPacket::setSender(int sender)
{
    this->sender = sender;
}

omnetpp::simtime_t FloodPacket::getSendingTimeInstace() const
{
    return this->sendingTimeInstace;
}

void FloodPacket::setSendingTimeInstace(omnetpp::simtime_t sendingTimeInstace)
{
    this->sendingTimeInstace = sendingTimeInstace;
}
...
FloodPacketDescriptor::FloodPacketDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(FloodPacket)), "omnetpp::cPacket")
{
...
unsigned int FloodPacketDescriptor::getFieldTypeFlags(int field) const
{
    ...
    static unsigned int fieldTypeFlags[] = {
        ...
        FD_ISEDITABLE,    // FIELD_sendingTimeInstace
    };
...
int FloodPacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (strcmp(fieldName, "sendingTimeInstace") == 0) return baseIndex + 1;
...
const char *FloodPacketDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        "int",    // FIELD_sender
        "omnetpp::simtime_t",    // FIELD_sendingTimeInstace
    };
...
std::string FloodPacketDescriptor::getFieldValueAsString(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_sendingTimeInstace: return simtime2string(pp->getSendingTimeInstace());
        default: return "";
    }
}
...
void FloodPacketDescriptor::setFieldValueAsString(omnetpp::any_ptr object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case FIELD_sendingTimeInstace: pp->setSendingTimeInstace(string2simtime(value)); break;
...
omnetpp::cValue FloodPacketDescriptor::getFieldValue(omnetpp::any_ptr object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case FIELD_sendingTimeInstace: return pp->getSendingTimeInstace().dbl();
...
void FloodPacketDescriptor::setFieldValue(omnetpp::any_ptr object, int field, int i, const omnetpp::cValue& value) const
{
    ...
    switch (field) {
        ...
        case FIELD_sendingTimeInstace: pp->setSendingTimeInstace(value.doubleValue()); break;
        default: throw omnetpp::cRuntimeError("Cannot set field %d of class 'FloodPacket'", field);
    }
}
